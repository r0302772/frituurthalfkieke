            ...
            <table class="table table-bordered border-dark">
                ...
                <%
                    for (Categorie categorie : categorien) {
                        out.print("<tr>"
                                + "<form action=\"/categorie/bewerken/result\" method=\"get\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\""+categorie.getId()+"\">"
                                + "<td><input type=\"text\" name=\"naam\" value=\""
                                + categorie.getNaam() + "\" class=\"form-control\" id=\"naam\" required>"
                                + "</td>"
                                ...
                                "</div></form>" +
                                        "<form class='col' action=\"/categorie/delete/result\" method=\"get\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\""+categorie.getId()+"\">"
                              +
