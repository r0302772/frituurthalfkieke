...
<c:forEach var="ItemWinkelwagen" items="${sessionScope.winkelwagen }">
    ...
    <tr class="">
        <td><a class="btn"
                ...
                onclick="return confirm('Bent u zeker dat u dit artikel wil verwijderen?')"><i class="bi bi-x-circle-fill"></i></a></td>
                    ...
                    <form autocomplete="off">
                        <div class="card-header bg-dark">
                            <div class="mx-0 mb-0 row justify-content-sm-center justify-content-start px-1">
                                <input type="text" id="dp1" class="datepicker" placeholder="Pick Date" name="date" readonly><span> <i class="bi bi-calendar-date-fill"></i></span>
                            </div>
                        </div>
                        <div class="card-body p-3 p-sm-5">
                            <div class="row text-center mx-0">
                               <div class="col-md-2 col-4 my-1 px-2"><a class="btn btn-outline-dark bg-danger text-warning" href=""><div class="cell py-1">9:00AM</div></a></div>
