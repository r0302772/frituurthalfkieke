...
<div class="container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main class="px-3">
        <div class="row px-3 text-center">
            <h2 class="display-5 fw-bold"><i class="bi bi-stopwatch-fill"></i> Bestellingen Beheren</h2>
        </div>
        <hr>
        <button type="button" class="btn btn-warning btn-lg">Online bestellingen blokkeren voor het komende uur!</button>
    </main>
